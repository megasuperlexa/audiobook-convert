...
I used to dual-boot to Windows and deal with iTunes and iBooks, which is not a pleasant experience, and sometimes iBooks just won't play books for unknown reasn. Here's 100% linux-friendly way (which doesnt require iTunes and wires at all):
...
3. On the device, from Telegram, send the book to the BookPlayer (via select-more-share-more-copy to BookPlayer)
Enjoy!
